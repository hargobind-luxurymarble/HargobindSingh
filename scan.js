...
// Multi-page setup: catalog data is written into catalog.js, not index.html
const HTML_FILE = path.join(__dirname, 'catalog.js');
...
function buildCatalog() {
  ...
  if (!fs.existsSync(HTML_FILE)) {
    console.error('\n❌  catalog.js not found at: ' + HTML_FILE);
    console.error('    Make sure scan.js is in the same folder as catalog.js\n');
    process.exit(1);
  }

  console.log('\n🔍  Scanning: ' + IMAGES_DIR);
  console.log('📄  Target:   catalog.js\n');
  ...
  console.log(`\n✅  ${allStones.length} item${allStones.length!==1?'s':''} embedded into catalog.js`);
